                ...
                DataStreamCollection(
                    ...
                    data_streams=[
                            ...
                            data_streams=[
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/ActivePatch.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    name="ActiveSite",
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/ActiveSite.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    name="ArmOdor",
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/ArmOdor.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    name="Block",
                                ...
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/ChoiceFeedback.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/DepletionVariable.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    name="GiveReward",
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/GiveReward.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/PatchRewardAmount.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/PatchRewardAvailable.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/PatchRewardProbability.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    name="RngSeed",
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/RngSeed.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/StopVelocityTreshold.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/VisualCorridorSpecs.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/WaitRewardOutcome.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/WaitLickOutcome.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/UpdaterStopDurationOffset.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/UpdaterStopVelocityThreshold.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/UpdaterRewardDelayOffset.json"
                                    ),
                                ),
                                SoftwareEvents(
                                    ...
                                    reader_params=SoftwareEvents.make_params(
                                        dataset_root
                                        / "behavior/SoftwareEvents/HabituationRewardAvailable.json"
                                    ),
                                ),
                            ],
                        ),
                        ...
                        Csv(
                            ...
                            reader_params=Csv.make_params(
                                path=dataset_root
                                / "behavior/OperationControl/IsStopped.csv",
                            ),
                        ),
                        Csv(
                            "Torque",
